...
-- # Class: "AssayOutputMeasurement" Description: "The measurement results produced by an assay. The specified output of a planned process. Each domain-specific assay class has a corresponding AssayOutputMeasurement subclass containing the named measurement slots for that assay type. This class represents the "output" in the Input/Process/Output model: what was measured and what values were obtained."
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
--     * Slot: description Description: A detailed description of the entity.
...
--     * Slot: disease_state Description: 
...
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
-- # Class: "CellTypeReference" Description: "A reference to a cell type from the Cell Ontology (CL)."
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
-- # Class: "SpeciesReference" Description: "A reference to a species from the NCBI Taxonomy."
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
-- # Class: "ChemicalEntityReference" Description: "A reference to a chemical entity from CHEBI or an exposure concept from ECTO."
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
-- # Class: "AnatomicalEntityReference" Description: "A reference to an anatomical entity from UBERON."
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
...
--     * Slot: cell_culture_growth_mode Description: 
--     * Slot: substrate_type Description: 
--     * Slot: passage_number Description: 
--     * Slot: coating Description: 
--     * Slot: matrix_composition Description: 
--     * Slot: organoid_type Description: 
...
--     * Slot: name Description: A human-readable name for the entity.
--     * Slot: description Description: A detailed description of the entity.
--     * Slot: cell_line_id Description: 
--     * Slot: primary_cell_id Description: 
...
--     * Slot: anatomical_origin_id Description: 
--     * Slot: confluence_level_id Description: 
--     * Slot: seeding_density_id Description: 
--     * Slot: size_range_id Description: 
--     * Slot: culture_conditions_id Description: 
--     * Slot: culture_media_id Description: 
--     * Slot: model_species_id Description: The species of origin for the cells or organism being studied. Reference to NCBITaxon term.
-- # Class: "CellLine" Description: "A cell line - a genetically stable cultured cell population."
--     * Slot: tissue_origin Description: 
--     * Slot: disease_state Description: 
--     * Slot: supplier Description: 
--     * Slot: catalog_number Description: 
--     * Slot: authentication_method Description: 
--     * Slot: mycoplasma_status Description: 
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
--     * Slot: cell_type_id Description: The cell type being studied. Reference to a Cell Ontology (CL) term. Used on CellularSystem and CellLine to describe the cell identity.
--     * Slot: model_species_id Description: The species of origin for the cells or organism being studied. Reference to NCBITaxon term.
-- # Class: "CellCultureConditions" Description: "Detailed cell culture parameters including medium, environment, and timing."
--     * Slot: days_at_air_liquid_interface Description: 
--     * Slot: passage_number Description: 
--     * Slot: substrate_type Description: 
--     * Slot: cell_culture_growth_mode Description: 
--     * Slot: donor_count Description: 
--     * Slot: replicates_per_donor Description: Number of biological replicates per donor.
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
--     * Slot: culture_media_id Description: 
-- # Class: "CellCultureMedium" Description: "Detailed formulation of cell culture medium including base medium and supplements."
--     * Slot: base_medium Description: 
--     * Slot: serum_type Description: 
--     * Slot: manufacturer Description: 
--     * Slot: catalog_number Description: 
--     * Slot: lot_number Description: 
--     * Slot: preparation_date Description: 
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
--     * Slot: serum_concentration_id Description: 
--     * Slot: osmolality_id Description: 
-- # Class: "MediumSupplement" Description: "Supplement or additive to cell culture medium."
--     * Slot: supplement_type Description: 
--     * Slot: manufacturer Description: 
--     * Slot: catalog_number Description: 
--     * Slot: id Description: A unique identifier for the entity.
--     * Slot: name Description: A human-readable name for the entity.
...
--     * Slot: id Description: 
--     * Slot: min_value_id Description: 
--     * Slot: max_value_id Description: 
--     * Slot: unit_id Description: The unit of measurement.
...
-- # Class: "AdverseOutcomePathway_stressors" Description: ""
--     * Slot: AdverseOutcomePathway_id Description: Autocreated FK slot
--     * Slot: stressors Description: Chemical or physical stressors that can trigger this AOP.
-- # Class: "Protocol_equipment_required" Description: ""
--     * Slot: Protocol_id Description: Autocreated FK slot
--     * Slot: equipment_required Description: Equipment required for this protocol.
-- # Class: "ImagingProtocol_equipment_required" Description: ""
--     * Slot: ImagingProtocol_id Description: Autocreated FK slot
--     * Slot: equipment_required Description: Equipment required for this protocol.
-- # Class: "StainingProtocol_antibodies_used" Description: ""
--     * Slot: StainingProtocol_id Description: Autocreated FK slot
--     * Slot: antibodies_used Description: Antibodies used in staining or detection.
-- # Class: "StainingProtocol_equipment_required" Description: ""
--     * Slot: StainingProtocol_id Description: Autocreated FK slot
--     * Slot: equipment_required Description: Equipment required for this protocol.
-- # Class: "SpirometryProtocol_equipment_required" Description: ""
--     * Slot: SpirometryProtocol_id Description: Autocreated FK slot
--     * Slot: equipment_required Description: Equipment required for this protocol.
-- # Class: "MolecularAssayProtocol_antibodies_used" Description: ""
--     * Slot: MolecularAssayProtocol_id Description: Autocreated FK slot
--     * Slot: antibodies_used Description: Antibodies used in staining or detection.
-- # Class: "MolecularAssayProtocol_primer_sequences" Description: ""
--     * Slot: MolecularAssayProtocol_id Description: Autocreated FK slot
--     * Slot: primer_sequences Description: Primer sequences used for PCR-based methods.
-- # Class: "MolecularAssayProtocol_equipment_required" Description: ""
--     * Slot: MolecularAssayProtocol_id Description: Autocreated FK slot
--     * Slot: equipment_required Description: Equipment required for this protocol.
-- # Class: "CellularSystem_cell_type_ratios" Description: ""
--     * Slot: CellularSystem_id Description: Autocreated FK slot
--     * Slot: cell_type_ratios Description: 
-- # Class: "CiliaryFunctionOutput_cell_type_ratios" Description: ""
--     * Slot: CiliaryFunctionOutput_id Description: Autocreated FK slot
--     * Slot: cell_type_ratios Description: 
-- # Class: "OxidativeStressOutput_protein_oxidation_markers" Description: ""
...
-- # Class: "EGFRSignalingOutput_pathway_biomarkers" Description: ""
...
CREATE TABLE "CellTypeReference" (
	id TEXT NOT NULL, 
	name TEXT, 
	PRIMARY KEY (id)
);
...
CREATE TABLE "ChemicalEntityReference" (
	id TEXT NOT NULL, 
	name TEXT, 
	PRIMARY KEY (id)
);
CREATE TABLE "AnatomicalEntityReference" (
	id TEXT NOT NULL, 
	name TEXT, 
	PRIMARY KEY (id)
);
...
CREATE TABLE "StudySubject" (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(model_species_id) REFERENCES "SpeciesReference" (id)
);
...
CREATE TABLE "CellLine" (
	...
	model_species_id TEXT, 
	PRIMARY KEY (id), 
	FOREIGN KEY(cell_type_id) REFERENCES "CellTypeReference" (id), 
	FOREIGN KEY(model_species_id) REFERENCES "SpeciesReference" (id)
);
...
CREATE TABLE "CellularSystem" (
	...
	FOREIGN KEY(primary_cell_id) REFERENCES "CellTypeReference" (id), 
	FOREIGN KEY(cell_type_id) REFERENCES "CellTypeReference" (id), 
	FOREIGN KEY(anatomical_origin_id) REFERENCES "AnatomicalEntityReference" (id), 
...
CREATE TABLE "BALFSputumAssay" (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY("Container_id") REFERENCES "Container" (id), 
	FOREIGN KEY(target_cell_type_id) REFERENCES "CellTypeReference" (id), 
	FOREIGN KEY(informs_on_key_event_id) REFERENCES "KeyEvent" (id), 
...
CREATE TABLE "ExposureCondition" (
	...
	FOREIGN KEY("FoxJExpressionAssay_id") REFERENCES "FoxJExpressionAssay" (id), 
	FOREIGN KEY("GeneExpressionAssay_id") REFERENCES "GeneExpressionAssay" (id), 
	FOREIGN KEY(exposure_agent_id) REFERENCES "ChemicalEntityReference" (id), 
